...
final class Helper {
	...
	/**
	 * Remove all wpvoicemessage audio files.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	public function remove_audio_files() {
		...
		/** Remove /wp-content/uploads/wpvoicemessage/ folder. */
		$dir = trailingslashit( wp_upload_dir()['basedir'] ) . 'wpvoicemessage';
	...
	public static function remove_settings() {
		...
		$settings = [
			'qcld_wpvm_vmwpmdp_voicemssg_envato_id',
			'qcld_wpvm_vmwpmdp_voicemssg_settings',
			'qcld_wpvm_vmwpmdp_voicemssg_floatbutton_settings',
			'qcld_wpvm_vmwpmdp_voicemssg_modalpopup_settings',
			'qcld_wpvm_vmwpmdp_voicemssg_messages_settings',
			'qcld_wpvm_vmwpmdp_voicemssg_assignments_settings',
			'qcld_wpvm_vmwpmdp_voicemssg_css_settings',
			'qcld_wpvm_vmwpmdp_voicemssg_uninstall_settings',
			'qcld_wpvm_vmwpmdp_voicemssg_default_form_id',
		];
	...
	public function inline_svg_e( $icon ) {
		...
		/** If icon from library. */
			...
			$icon = wpvoicemessage::$path . 'images/mdc-icons/' . $icon;
		}
	...
	public function get_remote( $url ) {
		...
		$args = [
			'timeout'    => 30,
			'user-agent' => 'wpvoicemessage-user-agent',
		];
